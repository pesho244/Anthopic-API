...
def generate_prompt_evaluation_report(evaluation_results):
    ...
    <head>
        ...
        <style>
            ...
            .output pre {{ background-color: #f5f5f5; border: 1px solid #ddd; border-radius: 4px; padding: 10px;
    ...
    for result in evaluation_results:
        ...
        criteria_string = "<br>&bull; ".join(result["test_case"]["solution_criteria"])
    ...
    def grade_output(self, test_case, output, extra_criteria):
        ...
        if extra_criteria:
            ...
            extra_criteria_section = self.render(
                dedent(extra_criteria_template), {"extra_criteria": extra_criteria}
            )
